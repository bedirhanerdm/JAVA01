...
public class Fp01 {
    ...
    public static void main(String[] args) {
        ...
        getEnKucukDeger1(liste); // odev
        System.out.println();

        getEnKucukDeger2(liste); // odev
        System.out.println();
    ...
    public static void ciftElemanlariYazdirFunctional(List<Integer> list){
        ...
        // Filter list olmadan kullanilamaz
    ...
    public static void getEnKucukDeger1(List<Integer> list){
    ...
    public static void getEnKucukDeger2(List<Integer> list){
